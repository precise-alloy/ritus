...
**Circuit breaker:** if the same finding recurs across 2 consecutive fix cycles, or 3 cycles pass without reaching a
clean state, stop and escalate to the user — the issue needs a design discussion, not another fix attempt.
