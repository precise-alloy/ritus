---
name: triage
description: Use before any implementation work - classifies changes by blast radius and recommends a model and effort. TRIGGER - invoke when user provides a requirement, feature request, or ticket key/URL (e.g., PROJ-123)
